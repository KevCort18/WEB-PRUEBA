...
export function HeroSection() {
  return (
    <section id="inicio" className="relative flex items-center justify-center text-center text-foreground overflow-hidden @container min-h-[480px] md:min-h-[calc(100vh-4rem)]">
      ...
      <div
        ...
        data-ai-hint="futuristic cityscape" // Updated hint
      >
      </div>
