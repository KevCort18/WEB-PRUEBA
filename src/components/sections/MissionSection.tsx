export function MissionSection() {
  return (
    <section id="mision" className="py-16 md:py-24 px-4">
      <h2 className="text-foreground text-3xl md:text-4xl font-bold leading-tight tracking-[-0.015em] pb-3 text-center mb-8">
        Nuestra Misión
      </h2>
